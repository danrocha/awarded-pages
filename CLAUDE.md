...
Static marketing website for the **Awarded** iOS app (App Store ID: 6752220611) - a movie tracking application for award-winning films.

### Files

- `index.html` - Landing page with app description and App Store link
...
- No build system, bundler, or dependencies
- Design system uses CSS custom properties (`:root` variables)

### Design Tokens

All pages share these CSS variables:
- `--bg: #020617` (dark background)
- `--text: #e2e8f0` (primary text)
- `--text-muted: #94a3b8` (secondary text)
- `--accent: #38bdf8` (links/highlights)
- `--card-bg: #1e293b` (card backgrounds, privacy page only)
...
### Third-Party Services (referenced in privacy policy)
